...
CREATE TABLE usuarios (
  ...
  `Contrasena`   VARCHAR(255) NOT NULL COMMENT 'Hash de contraseña.',
  rol            VARCHAR(50)  NOT NULL COMMENT 'donante | receptor | admin',
  telefono       VARCHAR(50)  NULL DEFAULT NULL COMMENT 'Teléfono del usuario.',
  Latitud        DECIMAL(10,8) NULL DEFAULT NULL COMMENT 'Latitud GPS.',
  Longitud       DECIMAL(11,8) NULL DEFAULT NULL COMMENT 'Longitud GPS.',
